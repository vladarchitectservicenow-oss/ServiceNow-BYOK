...
Build a production-ready ServiceNow scoped application that automates bring your own key (byok) configuration for the servicenow generative ai controller across azure openai, amazon bedrock, google vertex ai, and ibm watsonx.. The application must be installable on any Australia-era ServiceNow instance and must pass automated functional tests with zero external runtime dependencies.
